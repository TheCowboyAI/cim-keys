...
//! Value Objects for GUI State
//!
//! This module defines immutable value objects that group related state fields.
//! Following the principle: "a value object is replaced whole, not partially edited".
//!
//! ## N-ary FRP Compliance
//!
//! - A5 (Totality): All with_* methods are total functions
//! - A7 (Events): State changes create new value objects (events in time)
//! - A9 (Composition): Value objects compose into larger state
//!
//! ## Usage Pattern
//!
//! ```rust,ignore
//! // Replace whole value object, never mutate fields
//! let new_form = OrganizationForm {
//!     name: "New Org".to_string(),
//!     ..old_form
//! };
//! let new_app = CimKeysApp { organization_form: new_form, ..app };
//! ```
