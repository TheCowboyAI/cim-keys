...
impl DomainEventExt for DomainEvent {
    fn aggregate_id(&self) -> Uuid {
        match self {
            ...
            DomainEvent::CertificateImport(e) => e.aggregate_id(),
...
fn get_event_type(event: &DomainEvent) -> String {
    match event {
        ...
        DomainEvent::CertificateImport(e) => format!("CertificateImport.{}", std::any::type_name_of_val(e).split("::").last().unwrap_or("Unknown")),
