// State Machines for CIM Keys Workflows
//
// This module defines explicit state machines for all cryptographic workflows,
// ensuring proper sequencing and validation of operations.
